...
public class ShowActivity extends GDActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ImageLoaderMedium imageLoader=new ImageLoaderMedium(this.getApplicationContext());
...
//		new downloadShowExtraInfo().execute(imdbID);
	...
	private class downloadShowExtraInfo extends AsyncTask<String, Void, TvShow> {
		...
		protected TvShow doInBackground(String... params) {
			...
			try {
				...
				List<TvShow> showList = manager.userService().libraryShowsAll(username).fire();

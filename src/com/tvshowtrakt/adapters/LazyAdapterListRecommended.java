...
import com.tvshowtrakt.RecommendedActivity;
...
public class LazyAdapterListRecommended extends BaseAdapter {
	...
	public LazyAdapterListRecommended(RecommendedActivity a, List<TvShow> list,
			AQuery aq) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View vi = convertView;
		if (convertView == null)
			vi = inflater.inflate(R.layout.recommended_itemlist, null);
		...
		if (show.inWatchlist)
			...
			aq.id(R.id.watchlist).invisible();
